...
import { IdColetasSelecionadas, centroSelecionado, centros, coletas, ColetasType, nomeCentroSelecionado, setNomeCentro } from '@ecologika/helpers/holder';
import { ModalColetaValores } from '../modal/modalModels';
import { NativeStackScreenProps } from '@react-navigation/native-stack';

export function ListaColeta({ navigation } : NativeStackScreenProps<any>) {

  //Salva os dados com os IDs que batem
  const [dadosFiltrados, setDadosFiltrados] = useState<ColetasType[]>([]);
      ...
      <ScrollView style={styles.scrowView} overScrollMode='never' showsVerticalScrollIndicator={false}>
        ...
        <View key={index} style={styles.gridHolder}>
          ...
          {modalIndex === index && (
            ...
            >
              <ModalColetaValores handleClose={fecharModal} coleta={coleta} />
            </Modal>
          )}
