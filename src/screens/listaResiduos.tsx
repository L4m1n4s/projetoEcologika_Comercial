...
import { IdResiduosSelecionados, SetResiduosFinal, residuos, setResiduosSelecionadas } from '../helpers/holder';
import { ModalResiduoValores } from '../modal/modalModels';
import { NativeStackScreenProps } from '@react-navigation/native-stack';

export function ListaResiduos({ navigation } : NativeStackScreenProps<any>) {
