...
import { centroSelecionado, ColetasType, nomeCentroSelecionado, ResiduosType, tecnologiaTratamentoResiduos, unidadeMedida } from "../helpers/holder";
import { useState } from "react";
import DropDownPicker from 'react-native-dropdown-picker'

type modalModalColetaProps = {
    handleClose : () => void;
    coleta : ColetasType;
}

export function ModalColetaValores({ handleClose, coleta} : modalModalColetaProps) {
            ...
            <View style={styles.content}>
                ...
                <View style={styles.valousArea}>
                    <View style={styles.area}>
                        ...
                        <Text style={styles.numberColetas}>{coleta.centrosDeCusto[centroSelecionado][nomeCentroSelecionado].CustoDeTransporte}</Text>
                    </View>

                    <View style={styles.area}>
                        <Text style={styles.numberTextColetas}>Valor Ideal</Text>
                        <Text style={styles.numberColetas}>{coleta.centrosDeCusto[centroSelecionado][nomeCentroSelecionado].ValorIdeal}</Text>
                    </View>
                ...
                <View style={styles.valousArea}>
                    <View style={styles.area}>
                        ...
                        <Text style={styles.numberColetas}>{coleta.centrosDeCusto[centroSelecionado][nomeCentroSelecionado].ValorMedia}</Text>
                    </View>

                    <View style={styles.area}>
                        <Text style={styles.numberTextColetas}>Valor - 0,6535</Text>
                        <Text style={styles.numberColetas}>{coleta.centrosDeCusto[centroSelecionado][nomeCentroSelecionado].Valor065}</Text>
                    </View>
                </View>
...
type modalModalResiduoProps = {
    handleClose : () => void;
    residuo : ResiduosType;
}
export function ModalResiduoValores({ handleClose, residuo } :  modalModalResiduoProps) {
