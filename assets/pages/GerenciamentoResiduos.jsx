...
import { centros, coletas, residuos, setCentroDeCusto, setColetasSelecionadas, setResiduosSelecionadas } from './holder';


export function GerenciamentoResiduos({ navigation }) {
  ...
  return (
    <View style={styles.container}>
      ...
      <DropDownPicker style={styles.dropDown}
        ...
        onChangeValue={() => setCentroDeCusto(valueCentro)}
      />
